...
from slippi_ai.jax import embed, networks, jax_utils, opponent_pooling as opponent_pooling_lib
...
class Policy(nnx.Module, tp.Generic[ControllerType]):
...
class PolicyConfig:
  ...
  delay: int = 0
  opponent_pooling: opponent_pooling_lib.OpponentPoolingConfig = (
      utils.field(opponent_pooling_lib.OpponentPoolingConfig))
